...
def main() -> None:
    ...
    intro = f'<section class="hero"><h1>Fackeln am Abgrund</h1>{image_tag("/assets/860736_689a1b6e45ca4d3c8942cea5d9d79b41~mv2.webp", "Zwei gekreuzte Fackeln über dem Abgrund", False)}<h2>Tauche ein in die Welt des Shadowdark!</h2></section>'
    ...
    groups = [
        ("sessions", "Sessions", "Hier entfaltet sich die Geschichte unserer Abenteurer - bejubelt die Lebenden und ehret die Toten!"),
        ("hintergrund", "Hintergrund", "Hier sind Hintergrundinformationen zu finden."),
    ]
